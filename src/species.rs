...
use crate::universe::SandApi;
use crate::universe::Wind;
use crate::universe::EMPTY_CELL;
...
impl From<u8> for Species {
    fn from(orig: u8) -> Self {
        match orig {
            0 => return Species::Empty,
            1 => return Species::Wall,
            2 => return Species::Sand,
            3 => return Species::Water,
            4 => return Species::Gas,
            5 => return Species::Cloner,
            6 => return Species::Fire,
            7 => return Species::Wood,
            8 => return Species::Lava,
            9 => return Species::Ice,
            11 => return Species::Plant,
            12 => return Species::Acid,
            13 => return Species::Stone,
            14 => return Species::Dust,
            15 => return Species::Mite,
            16 => return Species::Oil,
            17 => return Species::Rocket,
            18 => return Species::Fungus,
            19 => return Species::Seed,
            _ => return Species::Empty,
        };
    }
}
...
pub fn update_plant(cell: Cell, mut api: SandApi) {
    ...
    {
        if api.get(0, 1).species == Species::Empty {
            let i = (api::frnd() * api::frnd() * 100.) as i32;
